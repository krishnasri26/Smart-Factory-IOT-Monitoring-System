...
{
  pinMode(PIN_LED_GREEN, OUTPUT);   //green led on means everything is normal
  pinMode(PIN_LED_YELLOW, OUTPUT);
  pinMode(PIN_LED_RED, OUTPUT);  //yellow led on means warning, if blinking something critical
